...
?>
<section class="t-count">Total count: <?php echo $model->getResultCount(); ?></section>
<?php
...
<?php if($value['destination_type']=="Places to visit") { ?>
    <section class=""><span class="placeholder"><?php echo $value['contained_in'][0]; ?></span></section>
<?php } ?>
...
//        'showLink'=>false,
//        'model'=>'sachin shantaram valanju',
//        'attribute'=>'Content',
//        'maxChar'=>20
//       ));
