...
$strXML .= getComponents('TOP_MOBILE', getComponentParams()); // components xml
...
$html = render_html('xsl/top_mobiles.xsl', $strXML, $_REQUEST['debug']);
