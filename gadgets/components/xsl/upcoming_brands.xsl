...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="UpcomingBrands">
        <xsl:if test="/XML/COMPONENTS_XML/MORE_ON_UPCMBRANDGADGET/COUNT &gt; 0">
            <section class="blksidebar">
                <h2 class="hdsd-blue">Upcoming Mobiles</h2>
                <ul class="sidebarlisting">
                    <xsl:for-each select="/XML/COMPONENTS_XML/MORE_ON_UPCMBRANDGADGET/MORE_ON_GADGET_DATA">
