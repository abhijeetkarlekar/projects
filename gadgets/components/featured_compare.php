...
//function arrGetFeaturedCompareSetDetails($featured_compare_ids="",$oncars_compare_id="",$category_ids="",$status="1",$ordering="",$startlimit="",$cnt="",$orderby=""){
    $result = $product->arrGetFeaturedCompareSetDetails("", "", $category_id, "1", "", $startlimit, $limitcnt);
    $cnt = sizeof($result);
    $component_xml .= "<FEATURED_COMPARE>";
...
//                            $product_info_id = $product_info_ids[$j];
...
//$image_path = resizeImagePath($image_path,"160X120",$aModuleImageResize);
            ...
            $component_xml .= "<FEATURED_COMPARE_DATA>";
