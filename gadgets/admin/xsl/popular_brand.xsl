...
<script language="javascript" src="{XML/ADMIN_JS_URL}popular_brand.js"></script>
					...
					<table class="form">
						...
						<tr>
							<td>
								...
								<div>
									<button class="btn btn-navy" name="select_category" id="select_category" onclick="javascript: getPopularBrandDashboard('prod_article_dashboard','productajaxloader','','{/XML/STARTLIMIT}','{/XML/CNT}','');">Select Category</button>
								</div>
							</td>
						</tr>
					</table>
