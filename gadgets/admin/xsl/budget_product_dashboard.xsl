...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Budget Product Management</h2>
            <div class="block">
                        ...
                        <tr class="odd gradeX">
                            <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="#Update" id="updateMe" onclick="updateBudgetProduct('prod_article_dashboard','productajaxloader','{BUDGET_PRODUCT_ID}','{PRODUCT_ID}','{CATEGORY_ID}','{BRAND_ID}','{PRODUCT_INFO_ID}','','');">Update</a>
                                                    |
                                                        <a href="javascript:undefined;" onclick="deleteBudgetProduct('{BUDGET_PRODUCT_ID}');">Delete</a>
                                                    </td>
                        </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        <div class="box round first grid">
        <h2>Budget Product Add/Update</h2>
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}budget_product.php" name="product_manage" id="product_manage">
            <table class="form">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <input type="hidden" name="budget_product_id" id="budget_product_id" value="{XML/PRODUCT_DATA/BUDGET_PRODUCT_ID}"/>
