...
<script LANGUAGE="JavaScript" SRC="{XML/ADMIN_JS_URL}model.js"></script>
						...
						<tr>
							<td>
								...
								<div >
                                            ...
                                            <button class="btn btn-navy" name="select_category" id="select_category" onclick="javascript: getProductModelDashboard('prod_article_dashboard','productajaxloader','','{/XML/STARTLIMIT}','{/XML/CNT}');">Select Category</button>	
                                        </div>
							</td>
						</tr>
					</table>
                            ...
                            <div id="prod_article_dashboard" style="display:block;">
                                        	Please select category for Model information.
                            </div>
		<div class="clear">
		</div>
	</div>
   ...
   <script>
            $(document).ready(function() {
                ...
                <xsl:if test="/XML/SELECTED_CATEGORY_ID!=''">
                        getProductModelDashboard('prod_article_dashboard','productajaxloader','<xsl:value-of select="/XML/SELECTED_CATEGORY_ID" diseable-output-escaping="yes"/>','<xsl:value-of select="/XML/STARTLIMIT" diseable-output-escaping="yes"/>','<xsl:value-of select="/XML/CNT" diseable-output-escaping="yes"/>');
                </xsl:if>
            });
