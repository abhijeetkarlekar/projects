...
<xsl:template match="/">
                        ...
                        <tr class="odd gradeX">
                            <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="#Update" id="updateMe" onclick="updateTopProduct('prod_article_dashboard','productajaxloader','{TOP_PRODUCT_ID}','{PRODUCT_ID}','{CATEGORY_ID}','{BRAND_ID}','{PRODUCT_INFO_ID}','','');">Update</a>
                                                    |
                                                        <a href="javascript:undefined;" onclick="deleteTopProduct('{TOP_PRODUCT_ID}');">Delete</a>
                                                    </td>
                        </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        ...
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}top_product.php" name="product_manage" id="product_manage">
            <table class="form">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <input type="hidden" name="top_product_id" id="top_product_id" value="{XML/PRODUCT_DATA/TOP_PRODUCT_ID}"/>
