...
<script LANGUAGE="JavaScript" SRC="{XML/ADMIN_JS_URL}featured_product.js"></script>
	...
	<div class="container_12">
		...
		<div class="grid_10">
			<div class="box round first grid">
				<h2>Featured Product Managemnt</h2>
				<div class="block">
					<table class="form">
		...
		<div id="prod_article_dashboard" style="display:block;">
                ...
                Please select category for Featured Product information.
