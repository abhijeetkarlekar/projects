...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Best Seller Product Management</h2>
            <div class="block">
                        ...
                        <tr class="odd gradeX">
                            <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="#Update" id="updateMe" onclick="updateBestSellerProduct('prod_article_dashboard','productajaxloader','{BEST_SELLER_PRODUCT_ID}','{PRODUCT_ID}','{CATEGORY_ID}','{BRAND_ID}','{PRODUCT_INFO_ID}','','');">Update</a>
                                                    |
                                                        <a href="javascript:undefined;" onclick="deleteBestSellerProduct('{BEST_SELLER_PRODUCT_ID}');">Delete</a>
                                                    </td>
                        </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        ...
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}best_seller_product.php" name="product_manage" id="product_manage">
            <table class="form">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <input type="hidden" name="best_seller_product_id" id="best_seller_product_id" value="{XML/PRODUCT_DATA/BEST_SELLER_PRODUCT_ID}"/>
