...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Other Product Management</h2>
            <div class="block">
                        ...
                        <tr class="odd gradeX">
                            <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="#Update" id="updateMe" onclick="updateOtherProduct('prod_article_dashboard','productajaxloader','{OTHER_PRODUCT_ID}','{PRODUCT_ID}','{CATEGORY_ID}','{BRAND_ID}','{PRODUCT_INFO_ID}','','');">Update</a>
                                                    |
                                                        <a href="javascript:undefined;" onclick="deleteOtherProduct('{OTHER_PRODUCT_ID}');">Delete</a>
                                                    </td>
                        </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        <div class="box round first grid">
        <h2>Other Product Add/Update</h2>
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}other_product.php" name="product_manage" id="product_manage">
            <table class="form">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <input type="hidden" name="other_product_id" id="other_product_id" value="{XML/PRODUCT_DATA/OTHER_PRODUCT_ID}"/>
