...
<xsl:template match="/">
                ...
                <table class="data display datatable" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                                        ...
                                        <td>
                                        <a href="javascript:void(0);" id="updateMe" onclick="updateProductVideos('prod_article_dashboard','productajaxloader','{PRODCUT_VIDEO_ID}','{PRODUCT_ID}','{PRODUCT_INFO_ID}','{CATEGORY_ID}','{BRAND_ID}','','');">Update</a>
                                        |
                                        <a href="javascript:undefined;" onclick="deleteProductVideos('{VIDEO_ID}');">Delete</a>
                                        </td>
                            </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        ...
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}add_video.php" name="product_manage" id="product_manage">
            <table class="form" id="Update">
                ...
                <tr>
                  ...
                  <td>
                    <select name="select_brand_id" id="select_brand_id" onchange="getModelByBrand('ajaxloader','0');">
                      ...
                      <xsl:choose>
                            <xsl:when test="/XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA/BRAND_ID=BRAND_ID">
                    ...
                    <input type="hidden" name="hd_select_brand_id" id="hd_select_brand_id" value="{/XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA/BRAND_ID}"/>
                ...
                <xsl:if test="count(/XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA)=0">
                        <tr style="border:1px solid #d5d5d5;">
                            ...
                            <td>
                                ...
                                <input class="medium" type="text" name="external_media_source_1" id="external_media_source_1" size="90" style="padding:8px;" value="{XML/ARTICLE_DATA/CONTENT}"/>
                                <br/>
                        ...
                        <xsl:if test="count(/XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA)>0">
                        <xsl:for-each select="/XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA">
                        <tr style="border:1px solid #d5d5d5;">
                            <td> <label>Video </label> <xsl:value-of select="position()"/></td>
                            ...
                            <label>Tags </label><br/><input class="medium" type="text" name="tags_{position()}" id="tags_{position()}" value="{TAGS}"/>
                            ...
                            <br/>
                            <label>Upload Media (upload video/audio/image) <xsl:value-of select="position()"/></label> <br/> 
                         ...
                         <input type="button" name="btn_get" id="btn_get" value="media upload" onclick="getUploadData('product_manage','title_upload_file_{position()}','media_id_{position()}','media_upload_1_{position()}','image','video_content_type_{position()}');"/>
                            ...
                            <span style="color:red;font-family:bold;">OR</span><br/>
                            <br/>
                            <label>Add Embed Media Code <xsl:value-of select="position()"/></label><br/>
                            ...
                            <input type="hidden" name="video_id_{position()}" id="video_id_{position()}" value="{VIDEO_ID}"/>
                            <input type="hidden" name="product_video_id_{position()}" id="product_video_id_{position()}" value="{PRODUCT_VIDEO_ID}"/>
                            <br/>
                        ...
                        <td colspan="14">
                          <input type="text" name="publish_time" id="publish_time" length="15" value="{XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA/PUBLISH_TIME}"/>(Format Required: YYYY-MM-DD HH:MM:SS)
                        </td>
                        </tr> -->
                ...
                <tr>
                    ...
                    <xsl:if test="/XML/WALLCNT!=0">
                        ...
                        <xsl:choose>
                            <xsl:when test="XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA/STATUS='Active'">
                        ...
                        <xsl:choose>
                            <xsl:when test="XML/VIDEO_DETAIL/VIDEO_DETAIL_DATA/STATUS='InActive'">
                            ...
                            <input type="hidden" name="video_id" id="video_id" value="{/XML/VIDEO_ID}"/>
