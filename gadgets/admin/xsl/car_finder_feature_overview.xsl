...
<title>Search Feature Overview Admin</title>
					...
					<table class="form">
						...
						<tr>
							<td>
								...
								<div>
									<button class="btn btn-navy" name="select_category" id="select_category" onclick="javascript:getCarFinderFeatureOverviewDashboard('feature_overview_dashboard','featureoverviewajaxloader','','{/XML/STARTLIMIT}','{/XML/CNT}');">Select Category</button>
								</div>
							</td>
						</tr>
					</table>
