...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Search Feature Overview Management</h2>
            <div class="block">
                    ...
                    <tbody>
                        ...
                        <xsl:for-each select="/XML/FEATURE_OVERVIEW_MASTER/FEATURE_OVERVIEW_MASTER_DATA">
                           ...
                           |
                            ...
                            <td>
                            <a href="javascript:undefined;" onclick="deleteCarFinderFeatureOverview('{OVERVIEW_ID}','{JS_FEATURE_NAME}','feature_overview_dashboard');">Delete</a>
                            </td>
                            </tr>
                            </xsl:for-each>
    ...
    <div class="grid_10">
        <div class="box round first grid">
        <h2>Search Feature Overview Add/Update</h2>
        <div class="block">
