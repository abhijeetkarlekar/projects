...
<title>Add Arrival Product</title>
...
<script LANGUAGE="JavaScript" SRC="{XML/ADMIN_JS_URL}newarrival_product.js"></script>
	...
	<div class="container_12">
		...
		<div class="grid_10">
			<div class="box round first grid">
				<h2>New Arrival Product Managemnt</h2>
				<div class="block">
					<table class="form">
		...
		<div id="prod_article_dashboard" style="display:block;">
                ...
                Please select category for New Arrival Product information.
