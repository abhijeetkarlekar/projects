...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Feature Sub Group Management</h2>
            <div class="block">
                <table class="data display datatable" id="example">
                    <thead>
                        <tr>
                            <th>Sr no.</th>
                            <th>Feature Main Group name</th>
    ...
    <div class="grid_10">
        <div class="box round first grid">
        <h2>Feature Sub Group Add/Update</h2>
        <div class="block">
            ...
            <form enctype="multipart/form-data" action="{XML/ADMIN_WEB_URL}feature_sub_group.php" method="post" name="feature_group_action" id="feature_group_action">
            <table class="form">
                <tr>
