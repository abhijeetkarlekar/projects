...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Featured Product Management</h2>
            <div class="block">
                        ...
                        <tr class="odd gradeX">
                            <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="#Update" id="updateMe" onclick="updateFeaturedProduct('prod_article_dashboard','productajaxloader','{FEATURED_PRODUCT_ID}','{PRODUCT_ID}','{CATEGORY_ID}','{BRAND_ID}','{PRODUCT_INFO_ID}','','');">Update</a>
                                                    |
                                                        <a href="javascript:undefined;" onclick="deleteFeaturedProduct('{FEATURED_PRODUCT_ID}');">Delete</a>
                                                    </td>
                        </tr>
                        </xsl:for-each>
    ...
    <div class="grid_10">
        ...
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}featured_product.php" name="product_manage" id="product_manage">
            <table class="form">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <input type="hidden" name="featured_product_id" id="featured_product_id" value="{XML/PRODUCT_DATA/FEATURED_PRODUCT_ID}"/>
