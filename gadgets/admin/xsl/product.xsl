						...
						<tr>
							<td>
								...
								<div >
                                            ...
                                            <button class="btn btn-navy" name="select_category" id="select_category" onclick="javascript:getProductDashboard('product_dashboard','productajaxloader','','{/XML/STARTLIMIT}','{/XML/CNT}','{/XML/SELECTED_BRAND_ID}','{/XML/SELECTED_MODEL_ID}','{/XML/SELECTED_VARIANT_ID}');">Select Category</button>	
                                        </div>
							</td>
						</tr>
					</table>
