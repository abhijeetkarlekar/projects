...
<xsl:template match="/">
    ...
    <div class="grid_10">
        <div class="box round first grid">
            <h2>Top Comparison Management</h2>
            <div class="block">
                View By Section :<select name="view_section_id" id="view_section_id" onchange="javascript: getTopOncarsComapreSetDashboardByType('prod_article_dashboard','productajaxloader','','{/XML/STARTLIMIT}','{/XML/CNT}','');">
                            <option value="0">---Select Section---</option>
                            <xsl:for-each select="/XML/TOP_COMPARISON_SET_MASTER/TOP_COMPARISON_SET">
                            <xsl:choose>
                ...
                <table class="data display datatable" id="example">
                    ...
                    <tbody>
                        <xsl:for-each select="/XML/TOP_COMPARISON_MASTER/TOP_COMPARISON_MASTER_DATA">
                        <tr class="odd gradeX">
                            <td>
                            ...
                            <td>
                                                        <a href="#Update" id="updateMe" onclick="updateFeaturedOncarsCompareSet('prod_article_dashboard','productajaxloader','{TOP_COMPARE_ID}','');">Update</a>
                                                    | <a href="javascript:undefined;" onclick="deleteFeaturedOncarsCompareSet('{TOP_COMPARE_ID}');">Delete</a></td>
    ...
    <div class="grid_10">
        <div class="box round first grid">
        <h2>Top Comparison Add/Update</h2>
        <div class="block">
            ...
            <form enctype="multipart/form-data" method="post" action="{XML/ADMIN_WEB_URL}top_oncars_comparison.php" name="product_manage" id="product_manage" >
            <table class="form">
                <tr>
                                                        <td><label>Top Compare Set Section</label></td>
                                                        <td colspan="10">
                ...
                <tr>
                            ...
                            <td id="select_comapre_list">
                                    ...
                                    <xsl:for-each select="/XML/ONCARS_COMPARE_SET_MASTER/ONCARS_COMPARE_SET_MASTER_DATA">
                                                                        <xsl:choose>
                                                                                <xsl:when test="/XML/TOP_ONCARS_DATA/ONCARS_COMPARE_ID=COMPETITOR_PRODUCT_ID">
                            ...
                            <tr>
                                    ...
                                    <xsl:for-each select="/XML/TOP_COMPARISON_MASTER/TOP_COMPARISON_ORDERING">
                                                                        <xsl:choose>
                                                                                <xsl:when test="/XML/TOP_ONCARS_DATA/ORDERING=TOP_COMPARISON_ORDERING_DATA">
                                                                                <option value="{TOP_COMPARISON_ORDERING_DATA}" selected='yes'>
                                                                                        <xsl:value-of select="TOP_COMPARISON_ORDERING_DATA"/>
                                                                                </option>
                                                                                </xsl:when>
                                                                                <xsl:otherwise>
                                                                                        <option value="{TOP_COMPARISON_ORDERING_DATA}">
                                                                                                <xsl:value-of select="TOP_COMPARISON_ORDERING_DATA"/>
                                                                                        </option>
                                                                                </xsl:otherwise>
                                                                        </xsl:choose>
                ...
                <tr>
                    ...
                    <td>
                        <select name="status" id="status">
                            <xsl:choose>
                                    <xsl:when test="/XML/TOP_ONCARS_DATA/STATUS='Active'">
                            ...
                            <xsl:choose>
                                    <xsl:when test="/XML/TOP_ONCARS_DATA/STATUS='InActive'">
                        ...
                        <input type="hidden" name="hd_top_compare_id" id="hd_top_compare_id" value="{/XML/TOP_ONCARS_DATA/TOP_COMPARE_ID}"/>
                    </td>
                </tr>
