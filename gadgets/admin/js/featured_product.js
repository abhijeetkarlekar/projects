function getProductArticleDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
    ...
    if(divid == ""){ return false; }
		var url = admin_web_url+'ajax/featured_product_dashboard_ajax.php';
...
function updateFeaturedProduct(divid,ajaxloaderid,latprdid,productid,categoryid,brandid,model_id,startlimit,cnt){
	if(category_id == ''){
		var category_id = document.getElementById('selected_category_id').value;
...
function deleteFeaturedProduct(ltPrdid){
	   	document.getElementById('actiontype').value = 'Delete';
		document.getElementById('featured_product_id').value = ltPrdid;
    	var answer = confirm ("Are you sure.Want to delete featured product?")
    	if (answer){
