function getProductArticleDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
    ...
    if(divid == ""){ return false; }
		var url = admin_web_url+'ajax/best_seller_product_dashboard.php';
...
function updateBestSellerProduct(divid,ajaxloaderid,latprdid,productid,categoryid,brandid,model_id,startlimit,cnt){
	if(category_id == ''){
		var category_id = document.getElementById('selected_category_id').value;
...
function deleteBestSellerProduct(ltPrdid){
	   	document.getElementById('actiontype').value = 'Delete';
		document.getElementById('best_seller_product_id').value = ltPrdid;
    	var answer = confirm ("Are you sure.Want to delete Top product?")
    	if (answer){
