function getProductArticleDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
    ...
    if(divid == ""){ return false; }
		var url = admin_web_url+'ajax/top_product_dashboard.php';
...
function updateTopProduct(divid,ajaxloaderid,latprdid,productid,categoryid,brandid,model_id,startlimit,cnt){
	if(category_id == ''){
		var category_id = document.getElementById('selected_category_id').value;
...
function deleteTopProduct(ltPrdid){
