function getFeatureGroupDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
	...
	document.getElementById(ajaxloaderid).style.display = "block";
        ...
        var url = admin_web_url+'ajax/feature_group_dashboard_ajax.php';
        $.ajax({
         url: url,
...
function updateFeatureGroup(featuregroupid,featuregroup,overview_display_name,featuregroupstatus){
	...
	overview_display_name = overview_display_name.replace(/%26/,"&");
	overview_display_name = overview_display_name.replace(/&#039;/,"'");
	overview_display_name = overview_display_name.replace(/%2C/,",");
	overview_display_name = overview_display_name.replace(/%2F/,"/");
	...
	document.getElementById('main_group_id').value = featuregroupid;
	document.getElementById('overview_display_group_name').value = overview_display_name;
