function getProductArticleDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
    ...
    if(divid == ""){ return false; }
		var url = admin_web_url+'ajax/other_product_dashboard.php';
...
function updateOtherProduct(divid,ajaxloaderid,latprdid,productid,categoryid,brandid,model_id,startlimit,cnt){
	if(category_id == ''){
		var category_id = document.getElementById('selected_category_id').value;
...
function deleteOtherProduct(ltPrdid){
	   	document.getElementById('actiontype').value = 'Delete';
		document.getElementById('other_product_id').value = ltPrdid;
