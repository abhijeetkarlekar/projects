function getTopOncarsComparisonDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
        if(category_id == ''){
	...
	if(divid == ""){ return false; }
        var url = admin_web_url+'ajax/top_oncars_comparison_dashboard.php';
...
function getTopOncarsComapreSetDashboardByType(divid,ajaxloaderid,category_id,startlimit,cnt,selected_section_id){
        //alert("dsdsdsdsds");
        if(category_id == ''){
                var category_id = document.getElementById('selected_category_id').value;
        }
...
function updateTopOncarsCompareSet(divid,ajaxloaderid,top_compare_id,category_id){
	...
	if(divid == ""){ return false; }
        var url = admin_web_url+'ajax/top_oncars_comparison_dashboard.php';
	//alert(url+'?act=update&top_compare_id='+top_compare_id+'&catid='+category_id+'&view_section_id='+view_section_id);
	$.ajax({
        	url: url,
                data: 'act=update&top_compare_id='+top_compare_id+'&catid='+category_id+'&view_section_id='+view_section_id,
                success: function(data){
                //alert(data);
                document.getElementById(divid).innerHTML = data;
                document.getElementById(divid).style.display="block";
...
function deleteTopOncarsCompareSet(top_compare_id){
        if(document.getElementById('view_section_id')!="undefined"){
        	var view_section_id = document.getElementById('view_section_id').value;
                document.getElementById('hd_view_section_id').value=view_section_id;
        }
        document.getElementById('actiontype').value = 'Delete';
	document.getElementById('hd_top_compare_id').value = top_compare_id;
