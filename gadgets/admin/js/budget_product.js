function getProductArticleDashboard(divid,ajaxloaderid,category_id,startlimit,cnt){
    ...
    if(divid == ""){ return false; }
		var url = admin_web_url+'ajax/budget_product_dashboard.php';
...
function updateBudgetProduct(divid,ajaxloaderid,latprdid,productid,categoryid,brandid,model_id,startlimit,cnt){
	if(category_id == ''){
		var category_id = document.getElementById('selected_category_id').value;
...
function deleteBudgetProduct(ltPrdid){
	   	document.getElementById('actiontype').value = 'Delete';
		document.getElementById('budget_product_id').value = ltPrdid;
    	var answer = confirm ("Are you sure.Want to delete budget product?")
    	if (answer){
