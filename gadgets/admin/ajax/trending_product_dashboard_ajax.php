<?php	
	...
	if(!empty($category_id)){
		...
		$result = $product->arrGetProductTrendingDetails("","",$category_id,"","",$startlimit,$limitcnt);
	}
	...
	if($_REQUEST['act']=='update' && !empty($trending_product_id)){
		...
		$rResult =$product->arrGetProductTrendingDetails($trending_product_id,"","","","",$startlimit,$limitcnt);
...
//print_r($result);
	...
	$xsl = DOMDocument::load('../xsl/trending_product_dashboard_ajax.xsl');
