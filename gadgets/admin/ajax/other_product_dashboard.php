<?php	
	...
	$other_product_id = $_REQUEST['lpid'];
	...
	if(!empty($category_id)){
		...
		$result = $product->arrGetOtherProductDetails("","",$category_id,"","",$startlimit,$limitcnt);
	}

	if($_REQUEST['other_product_id']!=''){
		$other_product_id = $_REQUEST['other_product_id'];
	}
	if($_REQUEST['act']=='Delete' && !empty($other_product_id)){
			$dresult = $product->boolDeleteOtherProduct($other_product_id);

	}
	
	if($_REQUEST['act']=='update' && !empty($other_product_id)){
                
		$rResult =$product->arrGetOtherProductDetails($other_product_id,"","","","",$startlimit,$limitcnt);
...
//print_r($result);
	...
	$xsl = DOMDocument::load('../xsl/other_product_dashboard.xsl');
