<?php	
	...
	$best_seller_product_id = $_REQUEST['lpid'];
	...
	if(!empty($category_id)){
		...
		$result = $product->arrGetBestSellerProductDetails("","",$category_id,"","",$startlimit,$limitcnt);
	}

	if($_REQUEST['best_seller_product_id']!=''){
		$best_seller_product_id = $_REQUEST['best_seller_product_id'];
	}
	if($_REQUEST['act']=='Delete' && !empty($best_seller_product_id)){
			$dresult = $product->boolDeleteBestSellerProduct($best_seller_product_id);

	}
	
	if($_REQUEST['act']=='update' && !empty($best_seller_product_id)){
                
		$rResult =$product->arrGetBestSellerProductDetails($best_seller_product_id,"","","","",$startlimit,$limitcnt);
...
//print_r($result);
	...
	$xsl = DOMDocument::load('../xsl/best_seller_product_dashboard.xsl');
