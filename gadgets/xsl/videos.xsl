    ...
    <!-- Header inner End-->    
        ...
        <div class="clear"></div>
                      ...
                      <xsl:call-template name="ModelMenuTab"/>  			 
                            ...
                            <h2 class="hdh2">
                                <xsl:value-of select="/XML/PRODUCT_DETAIL/PRODUCT_DETAIL_DATA/DISPLAY_PRODUCT_NAME" disable-output-escaping="yes" /> Video</h2>
                            <section class="blkdatawrap blkvideo">
                                <xsl:for-each select="/XML/MODEL_VIDEO_LIST/MODEL_VIDEO_LIST_DATA">
                                   
                                    <xsl:choose>
                                    <xsl:when test="/XML/VARIANT_VIDEO_SLUG!=''">    
                                        <xsl:if test="SLUG=/XML/VARIANT_VIDEO_SLUG">
