	   ...
	   <section class="container">
         <aside class="inner-container-left col-sm-9 ">
	       <section class="h-breadcrumb">
				<a class="home" href="javascript:void(0);"></a><span class="brdcrum-arr"></span> Budget Mobiles
                <div class="clear"></div>
			 </section>
              <h1 class="h118">budget-mobiles</h1>
				<section class="new-arrivals">
				   <section class="new-arrivals-inner">
				   	 <xsl:for-each select="/XML/BUDGET_PRODUCT_MASTER/BUDGET_PRODUCT_MASTER_DATA">
           <figure class="newarr-box col-xs-12 col-md-3">
              <a href="{SEO_URL}" class="imgwrap-big">
              <img src="{IMAGE_PATH}" />
            </a>
            <figcaption>
              <h2><a href="{SEO_URL}"><xsl:value-of select="PRODUCT_DISPLAY_NAME" disable-output-escaping="yes"/></a></h2>
              <div class="rs-info"><i class="rs"></i> <xsl:value-of select="VARIANT_PRICE" disable-output-escaping="yes"/></div>
