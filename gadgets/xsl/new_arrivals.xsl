	   ...
	   <section class="container">
         <aside class="inner-container-left col-sm-9 ">
	       <section class="h-breadcrumb">
				<a class="home" href="javascript:void(0);"></a><span class="brdcrum-arr"></span> New Arrivals
                <div class="clear"></div>
			 </section>
              <h1 class="h118">New Arrivals</h1>
				<section class="new-arrivals">
				   <section class="new-arrivals-inner">
				   
				    <xsl:for-each select="/XML/NEW_ARRIVALS_MASTER/NEW_ARRIVALS_MASTER_DATA">
